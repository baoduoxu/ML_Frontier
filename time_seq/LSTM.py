...
#         # output: (seq_len, batch, num_directions * hidden_size), hidden: (num_layers * num_directions, batch, hidden_size),其中num_directions为RNN的方向数,单向为1,双向为2, output是每个时间步LSTM的输出, hidden包含了每个隐藏层最后一个时间步的状态
